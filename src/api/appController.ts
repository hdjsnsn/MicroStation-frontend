...
/** 此处后端没有提供注释 GET /app/admin/getById */
export async function adminGetAppById(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.adminGetAppByIdParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseAppEntity>('/app/admin/getById', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** 此处后端没有提供注释 POST /app/featuredList */
export async function listFeaturedAppVoByPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVO>('/app/featuredList', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /app/myList */
export async function listMyAppVoByPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVO>('/app/myList', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
